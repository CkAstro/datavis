...
const ModalContent = () => (
   <div>
      ...
      <p>The <b>back end</b> runs on node+Express and will eventually process, store (upon request), and then serve user-submitted volumetric data in an easily-renderable data format. A user log-in is planned so both saved sessions and stored datasets are accessable from anywhere.</p>
   </div>
);
