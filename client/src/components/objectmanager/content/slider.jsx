...
function Slider({ props }) {
   ...
   const valDisplayArea = (
      <span
         className={`noselect ${style.varSliderValue}`}
   ...
   return (
      <div className={style.varSlider}>
         ...
         <input
            type="range"
            onChange={(e) =>
               changeSlideValue(e.target.value, props.ind, props.id)
            }
            min={props.min}
            max={props.max}
            value={props.value}
