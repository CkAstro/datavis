...
const DataVis = () => {
   ...
   return (
      <div className='mainLayout'
         onMouseUp={() => setIsActive(false)} onMouseMove={handleMouseMove}
         onTouchEnd={() => setIsActive(false)} onTouchMove={handleTouchMove}
      >
         <Header/>
         <div className='datavis'>
            <div className='noselect datavis__flex' style={{'--display-width': `${displayWidth}px`, '--display-height': `${displayHeight-38}px`}}>
               <Display/>
               <div className='datavis__divider' onMouseDown={() => setIsActive(true)} onTouchStart={() => setIsActive(true)}/>
               <Toolbar/>
            </div>
         </div>
      </div>
